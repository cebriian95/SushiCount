...
@Component({
  ...
  template: `
    <div class="flex min-h-dvh flex-col bg-white dark:bg-zinc-900 px-5 pt-6 text-zinc-900 dark:text-white">
      <!-- Top bar: toggle tema + título -->
      <div class="flex items-center justify-between">
        ...
        <div class="text-center">
          <h1 class="text-2xl font-bold tracking-tight">SushiCount</h1>
          <p class="text-xs text-zinc-400">¿Cuántas piezas puedes comer?</p>
        </div>
        <div class="w-9"></div>
      </div>
      ...
      @if (store.mejorSesion(); as mejor) {
        <div class="mt-5 rounded-2xl border border-yellow-500/40 bg-zinc-100 dark:bg-zinc-950 p-4 text-center">
      ...
      <!-- Media de sesiones -->
      <h2 class="mt-5 text-center text-lg font-semibold text-zinc-500 dark:text-zinc-400">Media de sesiones</h2>
      ...
      <!-- Botones inferiores -->
      <div class="flex gap-3 pb-4 mt-3">
        <button
